...
rollup index.js --format iife --name "myBundle" --file bundle.js
```
...
rollup index.js --format cjs --file bundle.js
```
...
rollup index.js --format umd --name "myBundle" --file bundle.js
```
